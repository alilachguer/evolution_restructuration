 ...
 * @generated
 */
public class Nom_modelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Nom_modelPackage.PEDESTRIAN: {
