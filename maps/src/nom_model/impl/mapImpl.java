 ...
 * </p>
 * <ul>
 *   <li>{@link nom_model.impl.mapImpl#getName <em>Name</em>}</li>
 *   <li>{@link nom_model.impl.mapImpl#getSpaces <em>Spaces</em>}</li>
 *   <li>{@link nom_model.impl.mapImpl#getRoads <em>Roads</em>}</li>
 * </ul>
 *
 * @generated
 */
public class mapImpl extends MinimalEObjectImpl.Container implements map {
	...
	protected EClass eStaticClass() {
		return Nom_modelPackage.Literals.MAP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Nom_modelPackage.MAP__NAME, oldName, name));
	}
	...
	public EList<PublicSpace> getSpaces() {
		if (spaces == null) {
			spaces = new EObjectContainmentEList<PublicSpace>(PublicSpace.class, this, Nom_modelPackage.MAP__SPACES);
		}
		return spaces;
	}
	...
	public EList<Road> getRoads() {
		if (roads == null) {
			roads = new EObjectContainmentEList<Road>(Road.class, this, Nom_modelPackage.MAP__ROADS);
		}
		return roads;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Nom_modelPackage.MAP__SPACES:
				return ((InternalEList<?>)getSpaces()).basicRemove(otherEnd, msgs);
			case Nom_modelPackage.MAP__ROADS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Nom_modelPackage.MAP__NAME:
				return getName();
			case Nom_modelPackage.MAP__SPACES:
				return getSpaces();
			case Nom_modelPackage.MAP__ROADS:
